...
R certainly is one of the best tools for data analysis that is available. One of the reasons is that it supports [web technologies](http://cran.r-project.org/web/views/WebTechnologies.html). So, equipped with this kind of information, how should one proceed?
